...
public class KafkaIO {
	...
	// ------------------------ Consult ----------------------
	// public RequestReplyFuture<String, String, String>
	// sendConsultRestaurant(String restaurantName) {
	//
	// ProducerRecord<String, String> record = new ProducerRecord<String,
	// String>("consult-restautant", restaurantName);
	// // set reply topic in header
	// record.headers().add(new RecordHeader(KafkaHeaders.REPLY_TOPIC,
	// "create-restaurant".getBytes()));
	// // post in kafka topic
	//
	...
	// public ListenableFuture<SendResult<String, String>> sendConsultOrder(String
	// restaurantName) {
	//
	// ProducerRecord<String, String> record = new ProducerRecord<String,
	// String>("consult-order", restaurantName);
	// // set reply topic in header
	// record.headers().add(new RecordHeader(KafkaHeaders.REPLY_TOPIC,
	// "consulter-restaurant".getBytes()));
	//
	// return kafkaTemplate.sendAndReceive("consult-order", restaurantName);
	// }

	// public ListenableFuture<SendResult<String, String>> sendConsultFood(String
	// restaurantName) {
	// ProducerRecord<String, String> record = new ProducerRecord<String,
	// String>("consult-restautant", restaurantName);
	// // set reply topic in header
	...
	// sendConsultFoodByCategory(String restaurantName) {
	// ProducerRecord<String, String> record = new ProducerRecord<String,
	// String>("consult-restautant", restaurantName);
	// // set reply topic in header
	// record.headers().add(new RecordHeader(KafkaHeaders.REPLY_TOPIC,
	...
	//
	// // ------------------------ Modif ----------------------
	// public ListenableFuture<SendResult<String, String>> sendEditRestaurant(String
	// restaurantName) {
	// ProducerRecord<String, String> record = new ProducerRecord<String,
	// String>("consult-restautant", restaurantName);
	// // set reply topic in header
	...
	// }
	//
	// public ListenableFuture<SendResult<String, String>> sendEditOrder(String
	// restaurantName) {
	// ProducerRecord<String, String> record = new ProducerRecord<String,
	// String>("consult-restautant", restaurantName);
	// // set reply topic in header
